...
def build_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # MACD, scaled by price so it is comparable across assets and time
    ...
    # Trend: distance from moving averages and short/long crossover
